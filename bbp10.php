...
//console.log(all_entries_json[5]["text"]);
//change handlers:
...
$("#fading_duration" ).change(function() {
    ...
    min_amount_of_circles_on_screen = 12;
    max_amount_of_circles_on_screen = 15;
...
function create_this_many_objects(this_many) {
    ...
    cx_max = svg_width - picture_margin;
    cy_min = 0 + picture_margin;
    cy_max = svg_height - picture_margin;

    textx_min = 0 + text_margin_left;
    textx_max = svg_width - text_margin_right;
    texty_min = 0 + text_margin_top_bottom;
    texty_max = svg_height - text_margin_top_bottom;
